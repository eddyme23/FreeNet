...
openssl req -x509 -nodes -newkey rsa:4096 -keyout /etc/hysteria/hysteria.key -out /etc/hysteria/hysteria.crt -sha256 -days 3650 -subj "/C=US/ST=Oregon/L=Portland/O=Company Name/OU=Org/CN=www.example.com"
